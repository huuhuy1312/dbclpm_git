...
public class Invoice {
    ...
    public Invoice(long id, long newNumber, long oldNumber, String period, long totalAll, long totalTax, long totalNoTax, String status) throws ParseException {
        this.id = id;
        this.newNumber = newNumber;
        this.oldNumber = oldNumber;
        this.period = parseDateString(period);
        this.totalAll = totalAll;
        this.totalTax = totalTax;
        this.totalNoTax = totalNoTax;
        this.status = status;
